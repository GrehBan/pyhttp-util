...
class CookieJar:
    ...
    def discard(self, name: str, domain: Optional[str] = None, path: str = "/") -> None:
    ...
    def filter(self, domain: str, path: str = "/", secure: bool = False) -> list[Cookie]:
    ...
    def output(self, domain: str, path: str = "/", secure: bool = False) -> str:
