...
class HeaderBuilder:
    """Static factory methods for creating standard HTTP headers."""
    ...
    def if_modified_since(value: str) -> Header:
        """Creates an If-Modified-Since header."""
    ...
    def accept_charset(value: str) -> Header:
        """Creates an Accept-Charset header."""
    ...
    def content_encoding(value: str) -> Header:
        """Creates a Content-Encoding header."""
    ...
    def content_location(value: str) -> Header:
        """Creates a Content-Location header."""
    ...
    def transfer_encoding(value: str) -> Header:
        """Creates a Transfer-Encoding header."""
    ...
    def content_security_policy_report_only(value: str) -> Header:
        """Creates a Content-Security-Policy-Report-Only header."""
    ...
    def feature_policy(value: str) -> Header:
        """Creates a Feature-Policy header."""
    ...
    def upgrade_insecure_requests(value: str) -> Header:
        """Creates an Upgrade-Insecure-Requests header."""
    ...
    def timing_allow_origin(value: str) -> Header:
        """Creates a Timing-Allow-Origin header."""
